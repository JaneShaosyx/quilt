...
- Updated `@shopify/react-graphql` dependency to `^6.1.23`.

## [3.3.8] - 2020-11-30

- Updated `@shopify/react-graphql` dependency to `^6.1.22`.

## [3.3.7] - 2020-11-30

- Updated `@shopify/react-graphql` dependency to `^6.1.21`.
